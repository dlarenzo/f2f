...
const Hero = ({ heading, heading2 }) => {
  return (
    <div
      id="home"
      className="flex items-center justify-center mt-25 h-[55vh] lg:h-[95vh] mb-12 bg-[url('/img/hero_bg3.jpg')] bg-fixed bg-left-top bg-cover"
    >
      {/* Overlay */}
      <div className="absolute top-0 left-0 right-0 bottom-0 mt-25 h-[55vh] lg:h-[95vh]  bg-black/70 z-[2]" />
      {/* End Overlay */}

      <div className="py-5 pl-10 md:pl-70 text-white z-[2]  mt-[-4rem] flex flex-col  items-end justify-center h-full w-7xl">
        <div className="flex flex-col pr-5">
          <h2 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-5">
            {heading}
          </h2>
