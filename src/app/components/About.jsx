...
const About = ({ heading }) => {
  return (
    <div id="about" className="px-5 mb-20 sm:mb-15">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-5">
          ...
          <p className="text-2xl text-gray-700 font-semibold w-full lg:w-1/2">
            We are a team of dedicated professionals committed to providing
            exceptional financial services. Our mission is to empower our
            clients with the knowledge and tools they need to achieve their
